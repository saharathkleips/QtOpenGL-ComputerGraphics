...
BaseEntity::BaseEntity( QString pathToModel, QString pathToTexture )
    :   m_pathToModel( pathToModel ), m_pathToTexture( pathToTexture )
{
    ModelLoader::loadModel( m_pathToModel, m_model, m_numVertices );
}
